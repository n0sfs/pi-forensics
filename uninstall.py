...
print("  - System packages (dc3dd, nginx, gddrescue, …) were left installed.")
print("    Remove them with apt if desired, e.g.:")
print("      sudo apt remove dc3dd ewf-tools gddrescue nginx")
