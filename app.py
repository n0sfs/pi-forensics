...
from core.jobs import (
    ...
    _stream_subprocess, poll_directory_size, CaseEventTarget,
...
from core.paths import (
    ...
    is_valid_block_device, _DEVICE_RE,
)
...
# --- Chain of Custody log/export, the case-notes/attach/discover
# cluster, and the entire PDF/HTML report-builder helper block
# (REPORT_TEMPLATES/REPORT_SECTION_BLOCKS, every _draw_pdf_*/_html_*
# drawing helper, /api/export_report) all moved to routes/reporting.py -
# see the dated CLAUDE.md entry for this refactor.
